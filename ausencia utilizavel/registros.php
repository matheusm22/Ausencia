<?php
    ...
    include_once('config.php');
     ...
     print_r($_SESSION);
    if((!isset($_SESSION['agente']) == true) and (!isset($_SESSION['senha']) == true) )
    {
    ...
    $logado = $_SESSION['agente'];
    if(!empty($_GET['search']))
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM ausencia WHERE  id LIKE '%$data%' or nome LIKE '%$data%' or setor LIKE  '%$data%' ORDER BY id DESC";
    }
    else
    {
        $set = $_SESSION['setor'];
        $sql = "SELECT * FROM ausencia WHERE setor LIKE '$set' ORDER BY id DESC";
    }
    if(empty($_SESSION['setor'])) {
        $sql = "SELECT * FROM ausencia ORDER BY id DESC";
    }
